...
function qa(a,b){a.j={na:b,qa:!0};a.h=a.o||a.m}
...
function sa(a){a.o=0;var b=a.j.na;a.j=null;return b}
function ta(a){a.B=[a.j];a.o=0;a.m=0}
function va(a){var b=a.B.splice(0)[0];(b=a.j=a.j||b)?b.qa?a.h=a.o||a.m:void 0!=b.v&&a.m<b.v?(a.h=b.v,a.j=null):a.h=a.m:a.h=0}
...
function za(a){for(;a.h.h;)try{var b=a.i(a.h);if(b)return a.h.s=!1,{value:b.value,done:!1}}catch(c){a.h.i=void 0,qa(a.h,c)}a.h.s=!1;if(a.h.j){b=a.h.j;a.h.j=null;if(b.qa)throw b.na;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
...
b.prototype.W=function(g){if(g===this)this.m(new TypeError("A Promise cannot resolve to itself"));else if(g instanceof b)this.xa(g);else{a:switch(typeof g){case "object":var h=null!=g;break a;case "function":h=!0;break a;default:h=!1}h?this.V(g):this.o(g)}};
b.prototype.V=function(g){var h=void 0;try{h=g.then}catch(k){this.m(k);return}"function"==typeof h?this.ya(h,g):this.o(g)};
b.prototype.m=function(g){this.u(2,g)};
b.prototype.o=function(g){this.u(1,g)};
b.prototype.u=function(g,h){if(0!=this.h)throw Error("Cannot settle("+g+", "+h+"): Promise already settled in state"+this.h);this.h=g;this.j=h;2===this.h&&this.fa();this.B()};
b.prototype.fa=function(){var g=this;e(function(){if(g.N()){var h=da.console;"undefined"!==typeof h&&h.error(g.j)}},1)};
...
var f=new c;b.prototype.xa=function(g){var h=this.l();g.Z(h.resolve,h.reject)};
...
this.Z(k(g,l),k(h,n));return q};
b.prototype.catch=function(g){return this.then(void 0,g)};
b.prototype.Z=function(g,h){function k(){switch(l.h){case 1:g(l.j);break;case 2:h(l.j);break;default:throw Error("Unexpected state: "+l.h);}}
var l=this;null==this.i?f.i(k):this.i.push(k);this.s=!0};
b.resolve=d;b.reject=function(g){return new b(function(h,k){k(g)})};
b.race=function(g){return new b(function(h,k){for(var l=u(g),n=l.next();!n.done;n=l.next())d(n.value).Z(h,k)})};
b.all=function(g){var h=u(g),k=h.next();return k.done?d([]):new b(function(l,n){function q(x){return function(A){t[x]=A;p--;0==p&&l(t)}}
var t=[],p=0;do t.push(void 0),p++,d(k.value).Z(q(t.length-1),n),k=h.next();while(!k.done)})};
return b});
...
;function Pa(a,b){if(Error.captureStackTrace)Error.captureStackTrace(this,Pa);else{var c=Error().stack;c&&(this.stack=c)}a&&(this.message=String(a));b&&(this.Ba=b)}
...
m=Ab.prototype;m.pa=!0;m.oa=function(){return this.i};
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var l,n;a();return{reset:a,update:c,digest:d,Ca:function(){for(var q=d(),t="",p=0;p<q.length;p++)t+="0123456789ABCDEF".charAt(Math.floor(q[p]/16))+"0123456789ABCDEF".charAt(q[p]%16);return t}}}
...
function Cc(a){var b=zc();b.update(a);return b.Ca().toLowerCase()}
;var Dc={};function Ec(a){this.h=a||{cookie:""}}
m=Ec.prototype;m.isEnabled=function(){if(!z.navigator.cookieEnabled)return!1;if(!this.isEmpty())return!0;this.set("TESTCOOKIESENABLED","1",{ha:60});if("1"!==this.get("TESTCOOKIESENABLED"))return!1;this.remove("TESTCOOKIESENABLED");return!0};
m.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.lb;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.ha}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);this.h.cookie=a+"="+b+(f?";domain="+f:"")+(g?";path="+g:"")+(0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString())+(d?";secure":"")+(null!=e?";samesite="+e:"")};
...
return function(e){d.next={la:e};d=d.next;b.port2.postMessage(0)}}return function(e){z.setTimeout(e,0)}}
...
wd.prototype.preventDefault=function(){wd.G.preventDefault.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var yd="closure_listenable_"+(1E6*Math.random()|0);var zd=0;function Ad(a,b,c,d,e){this.listener=a;this.h=null;this.src=b;this.type=c;this.capture=!!d;this.ba=e;this.key=++zd;this.T=this.Y=!1}
function Bd(a){a.T=!0;a.listener=null;a.h=null;a.src=null;a.ba=null}
;function Cd(a){this.src=a;this.listeners={};this.h=0}
Cd.prototype.add=function(a,b,c,d,e){var f=a.toString();a=this.listeners[f];a||(a=this.listeners[f]=[],this.h++);var g=Dd(a,b,d,e);-1<g?(b=a[g],c||(b.Y=!1)):(b=new Ad(b,this.src,f,!!d,e),b.Y=c,a.push(b));return b};
...
function Dd(a,b,c,d){for(var e=0;e<a.length;++e){var f=a[e];if(!f.T&&f.listener==b&&f.capture==!!c&&f.ba==d)return e}return-1}
;var Fd="closure_lm_"+(1E6*Math.random()|0),Gd={},Hd=0;function Id(a,b,c,d,e){if(d&&d.once)Jd(a,b,c,d,e);else if(Array.isArray(b))for(var f=0;f<b.length;f++)Id(a,b[f],c,d,e);else c=Kd(c),a&&a[yd]?a.ca(b,c,C(d)?!!d.capture:!!d,e):Ld(a,b,c,!1,d,e)}
...
function Pd(a,b){if(a.T)a=!0;else{b=new wd(b,this);var c=a.listener,d=a.ba||a.src;a.Y&&Rd(a);a=c.call(d,b)}return a}
...
return a[Sd]}
;function L(){hd.call(this);this.h=new Cd(this);this.fa=this;this.s=null}
...
function Td(a,b){var c=a.s;if(c){var d=[];for(var e=1;c;c=c.s)d.push(c),++e}a=a.fa;c=b.type||b;"string"===typeof b?b=new vd(b,a):b instanceof vd?b.target=b.target||a:(e=b,b=new vd(c,a),db(b,e));e=!0;if(d)for(var f=d.length-1;!b.j&&0<=f;f--){var g=b.h=d[f];e=Ud(g,c,!0,b)&&e}b.j||(g=b.h=a,e=Ud(g,c,!0,b)&&e,b.j||(e=Ud(g,c,!1,b)&&e));if(d)for(f=0;!b.j&&f<d.length;f++)g=b.h=d[f],e=Ud(g,c,!1,b)&&e}
...
L.prototype.ca=function(a,b,c,d){return this.h.add(String(a),b,!1,c,d)};
function Ud(a,b,c,d){b=a.h.listeners[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var g=b[f];if(g&&!g.T&&g.capture==c){var h=g.listener,k=g.ba||g.src;g.Y&&Ed(a.h,g);e=!1!==h.call(k,d)&&e}}return e&&!d.defaultPrevented}
...
function cg(a,b){if("log_event"===a.endpoint){var c="";a.aa?c="visitorOnlyApprovedKey":a.H&&(bg[a.H.token]=dg(a.H),c=a.H.token);var d=ag.get(c)||[];ag.set(c,d);d.push(a.payload);b&&(Wf=new b);a=gf("tvhtml5_logging_max_batch")||gf("web_logging_max_batch")||100;b=R();d.length>=a?eg({writeThenSend:!0}):10<=b-Zf&&(fg(),Zf=b)}}
function gg(a,b){if("log_event"===a.endpoint){var c="";a.aa?c="visitorOnlyApprovedKey":a.H&&(bg[a.H.token]=dg(a.H),c=a.H.token);var d=new Map;d.set(c,[a.payload]);b&&(Wf=new b);return new Wd(function(e){Wf&&Wf.isReady()?hg(d,e,{bypassNetworkless:!0}):e()})}}
...
vg.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.h)try{this.h.set(a,b,Date.now()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Vd(b))}catch(f){return}else e=escape(b);b=this.i;Fc.set(""+a,e,{ha:c,path:"/",domain:void 0===b?"youtube.com":b,secure:!1})};
...
na(V,Jg);function Qg(a){V.call(this,"MISSING_OBJECT_STORE",{Na:a},Ng.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,Qg.prototype)}
...
closed:b,Qa:b,upgrade:this.options.upgrade};return this.h=d=a()};var xh=new vh("YtIdbMeta",{ja:{databases:{X:1}},upgrade:function(a,b){b(1)&&fh(a,"databases",{keyPath:"actualName"})}});
...
Kh.prototype.i=function(a,b,c){c=void 0===c?{}:c;return(this.options.wa?Hh:Gh)(a,b,Object.assign({},c))};
Kh.prototype.delete=function(a){a=void 0===a?{}:a;return(this.options.wa?Jh:Ih)(this.name,a)};var Mh;
function Nh(){if(Mh)return Mh();var a={};Mh=Lh({ja:(a.LogsRequestsStore={X:2},a.sapisid={X:2},a.SWHealthLog={X:3},a),wa:!1,upgrade:function(b,c,d){c(2)&&(fh(b,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0}),fh(b,"sapisid"));c(3)&&fh(b,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).h.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1});c(5)&&(b=eh(d,"LogsRequestsStore"),b.h.indexNames.contains("newRequest")&&b.h.deleteIndex("newRequest"),b.h.createIndex("newRequestV2",["status",
...
function Ph(a){var b=gf("nwl_latency_sampling_rate",.01);!(.02<b)&&Math.random()<=b&&(b=B("ytPubsub2Pubsub2Instance"))&&b.publish.call(b,"nwl_transaction_latency_payload".toString(),"nwl_transaction_latency_payload",a)}
...
;var Xh=gf("network_polling_interval",3E4);function Y(){L.call(this);this.V=0;this.u=this.l=!1;this.N=0;this.W=!1;this.i=this.ga();Yh(this);Zh(this)}
...
m.Oa=function(a){this.l=!0;if(void 0===a?0:a)this.V||ai(this)};
m.ga=function(){var a=window.navigator.onLine;return void 0===a?!0:a};
m.Da=function(){this.W=!0};
m.ca=function(a,b){return L.prototype.ca.call(this,a,b)};
function Zh(a){window.addEventListener("online",function(){return I(a,function c(){var d=this;return y(c,function(e){if(1==e.h)return w(e,d.L(),2);bi(d);if(d.W&&Q("offline_error_handling")){var f=Vh().get("errors",!0);if(f){for(var g in f)if(f[g]){var h=new Jg(g,"sent via offline_errors");h.name=f[g].name;h.stack=f[g].stack;h.level=f[g].level;Le(h)}Vh().set("errors",{},2592E3,!0)}}e.h=0})})})}
function Yh(a){window.addEventListener("offline",function(){return I(a,function c(){var d=this;return y(c,function(e){if(1==e.h)return w(e,d.L(),2);bi(d);e.h=0})})})}
function ai(a){a.V=jf(function(){return I(a,function c(){var d=this;return y(c,function(e){if(1==e.h){if(!d.i)return w(e,d.L(),3);if(d.ga())return e.v(3);d.u=!0;d.N=R();return d.l?w(e,d.L(),3):e.v(3)}ai(d);e.h=0})})},Xh)}
function bi(a){a.u&&(Me(new Jg("NetworkStatusManager state did not match poll",R()-a.N)),a.u=!1)}
m.L=function(a){var b=this;return this.o?this.o:this.o=new Promise(function(c){return I(b,function e(){var f,g,h,k=this;return y(e,function(l){switch(l.h){case 1:return f=window.AbortController?new window.AbortController:void 0,g=null===f||void 0===f?void 0:f.signal,h=!1,ra(l,2,3),f&&(k.B=lf(function(){f.abort()},a||2E4)),w(l,fetch("/generate_204",{method:"HEAD",
signal:g}),5);case 5:h=!0;case 3:ta(l);k.o=void 0;k.B&&nf(k.B);h!==k.i&&(k.i=h,k.i&&k.l?Td(k,"ytnetworkstatus-online"):k.l&&Td(k,"ytnetworkstatus-offline"));c(h);va(l);break;case 2:sa(l),h=!1,l.v(3)}})})})};
Y.prototype.sendNetworkCheckRequest=Y.prototype.L;Y.prototype.listen=Y.prototype.ca;Y.prototype.enableErrorFlushing=Y.prototype.Da;Y.prototype.getWindowStatus=Y.prototype.ga;Y.prototype.monitorNetworkStatusChange=Y.prototype.Oa;Y.prototype.isNetworkAvailable=Y.prototype.J;Y.getInstance=$h;function ci(a){a=void 0===a?{}:a;L.call(this);var b=this;this.l=this.u=0;this.i=$h();var c=B("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.i);c&&c(a.Ea);a.Ma&&(c=B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.i))&&c();if(c=B("yt.networkStatusManager.instance.listen").bind(this.i))a.ea?(this.ea=a.ea,c("ytnetworkstatus-online",function(){di(b,"publicytnetworkstatus-online")}),c("ytnetworkstatus-offline",function(){di(b,"publicytnetworkstatus-offline")})):
...
na(ci,L);ci.prototype.J=function(){var a=B("yt.networkStatusManager.instance.isNetworkAvailable").bind(this.i);return a?a():!0};
...
function di(a,b){a.ea?a.l?(nf(a.u),a.u=lf(function(){a.o!==b&&(Td(a,b),a.o=b,a.l=R())},a.ea-(R()-a.l))):(Td(a,b),a.o=b,a.l=R()):Td(a,b)}
;var ei=0,fi=0,gi,hi=z.ytNetworklessLoggingInitializationOptions||{isNwlInitialized:!1,isIdbSupported:!1,potentialEsfErrorCounter:fi};Q("export_networkless_options")&&D("ytNetworklessLoggingInitializationOptions",hi);function ii(a,b){function c(d){var e=ji().J();if(!ki()||!d||e&&Q("vss_networkless_bypass_write"))li(a,b);else{var f={url:a,options:b,timestamp:R(),status:"NEW",sendCount:0};Oh(f).then(function(g){f.id=g;(ji().J()||Q("networkless_always_online"))&&mi(f)}).catch(function(g){mi(f);
ji().J()?Le(g):Wh(g)})}}
b=void 0===b?{}:b;Q("skip_is_supported_killswitch")?Ch().then(function(d){c(d)}):c(ni())}
...
li(e.url,e.options);Oh(e).then(function(h){e.id=h;f&&Th(e.id)}).catch(function(h){ji().J()?Le(h):Wh(h)})}else li(a,b)}
b=void 0===b?{}:b;Q("skip_is_supported_killswitch")?Ch().then(function(d){c(d)}):c(ni())}
function pi(){var a=this;ei||(ei=lf(function(){return I(a,function c(){var d;return y(c,function(e){if(1==e.h)return w(e,Qh(),2);if(3!=e.h)return d=e.i,d?w(e,mi(d),3):(nf(ei),ei=0,e.return());ei&&(ei=0,pi());e.h=0})})},100))}
function mi(a){return I(this,function c(){var d;return y(c,function(e){switch(e.h){case 1:if(void 0===a.id){e.v(2);break}return w(e,Rh(a.id),3);case 3:(d=e.i)?a=d:Me(Error("The request cannot be found in the database."));case 2:var f=a.timestamp;if(!(2592E6<=R()-f)){e.v(4);break}Me(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===a.id){e.v(5);break}return w(e,Th(a.id),5);case 5:return e.return();case 4:f=a=qi(a);var g,h;if(null===(h=null===(g=null===f||void 0===f?void 0:
f.options)||void 0===g?void 0:g.postParams)||void 0===h?0:h.requestTimeMs)f.options.postParams.requestTimeMs=Math.round(R());(a=f)&&li(a.url,a.options);e.h=0}})})}
function qi(a){var b=this,c=a.options.onError?a.options.onError:function(){};
...
return a}
function ji(){gi||(gi=new ci({Ma:!0,Ea:!0}));return gi}
...
function ni(){return B("ytNetworklessLoggingInitializationOptions")?hi.isIdbSupported:!1}
...
c.onFetchSuccess=function(v,K){zg(p);A(v,K)}}try{t&&d.retry&&!d.sa.bypassNetworkless?(g.method="POST",!d.sa.writeThenSend&&Q("nwl_send_fast_on_unload")?oi(q,g):ii(q,g)):(g.method="POST",g.postParams||(g.postParams={}),xf(q,g))}catch(v){if("InvalidAccessError"==v.name)p&&(zg(p),p=0),Me(Error("An extension is blocking network request."));
...
timeout:d.timeout,withCredentials:!0},h="";(f=a.config_.Ja)&&(h=f);var k=a.config_.La||!1,l=tg(k,h,d);Object.assign(g.headers,l);g.headers.Authorization&&!h&&(g.headers["x-origin"]=window.location.origin);f="/youtubei/"+a.config_.innertubeApiVersion+"/"+b;var n={alt:"json"};a.config_.Ka&&g.headers.Authorization||(n.key=a.config_.innertubeApiKey);var q=df(""+h+f,n||{},!0);ki()?Ch().then(function(t){e(t)}):e(!1)}
;function si(a,b){var c=void 0===c?{}:c;var d=ri;O("ytLoggingEventsDefaultDisabled",!1)&&ri==ri&&(d=null);c=void 0===c?{}:c;var e={},f=Math.round(c.timestamp||R());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;a=B("_lact",window);a=null==a?-1:Math.max(Date.now()-a,0);e.context={lastActivityMs:String(c.timestamp||!isFinite(a)?-1:a)};Q("log_sequence_info_on_gel_web")&&c.va&&(a=e.context,b=c.va,ng[b]=b in ng?ng[b]+1:0,a.sequence={index:ng[b],groupKey:b},c.hb&&delete ng[c.va]);(c.mb?gg:cg)({endpoint:"log_event",
payload:e,H:c.H,aa:c.aa},d)}
;var ti=[{ia:function(a){return"Cannot read property '"+a.key+"'"},
...
da:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var vi={K:[],I:[{Aa:ui,weight:500}]};function ui(a){a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
...
m=Xi.prototype;m.setSize=function(a,b){this.h.width=a.toString();this.h.height=b.toString();return this};
m.za=function(){return this.h};
m.ka=function(a){Yi(this,a.event,a)};
...
b.toString());var g=a.ma();g.enablejsapi=window.postMessage?1:0;window.location.host&&(g.origin=window.location.protocol+"//"+window.location.host);g.widgetid=a.id;window.location.href&&G(["debugjs","debugcss"],function(h){var k=Lb(window.location.href,h);null!==k&&(g[h]=k)});
...
function cj(a){Vi(a.i,a,a.id);a.j=We(a.ta.bind(a));Ue(a.h,"load",function(){window.clearInterval(a.j);a.j=We(a.ta.bind(a))})}
m.setup=function(a,b){var c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?Hb(a.src):"https://www.youtube.com"),this.i=new Ti(b),c||(b=bj(this,a),this.m=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.h=a,this.h.id||(this.h.id="widget"+Ia(this.h)),Ni[this.h.id]=this,window.postMessage){this.l=new M;cj(this);b=Z(this.i,"events");for(var d in b)b.hasOwnProperty(d)&&this.addEventListener(d,b[d]);for(var e in Pi)Pi.hasOwnProperty(e)&&
$i(this,e)}};
...
g)}if(!(5<=Gi)){g=void 0;var k=f,l=dd(e);f=l.message||"Unknown Error";h=l.name||"UnknownError";var n=l.stack||e.i||"Not available";if(n.startsWith(h+": "+f)){var q=n.split("\n");q.shift();n=q.join("\n")}q=l.lineNumber||"Not available";l=l.fileName||"Not available";var t=0;if(e.hasOwnProperty("args")&&e.args&&e.args.length)for(g=0;g<e.args.length&&!(t=Ci(e.args[g],"params."+g,k,t),500<=t);g++);else if(e.hasOwnProperty("params")&&e.params){var p=e.params;if("object"===typeof e.params)for(g in p){if(p[g]){var x=
"params."+g,A=Ei(p[g]);k[x]=A;t+=x.length+A.length;if(500<t)break}}else k.params=Ei(p)}if(Ji.length)for(g=0;g<Ji.length&&!(t=Ci(Ji[g],"params.context."+g,k,t),500<=t);g++);navigator.vendor&&!k.hasOwnProperty("vendor")&&(k["device.vendor"]=navigator.vendor);g={message:f,name:h,lineNumber:q,fileName:l,stack:n,params:k,sampleWeight:1};f=Number(e.columnNumber);isNaN(f)||(g.lineNumber=g.lineNumber+":"+f);if("IGNORED"===e.level)e=0;else a:{e=yi();f=u(e.K);for(h=f.next();!h.done;h=f.next())if(h=h.value,
g.message&&g.message.match(h.jb)){e=h.weight;break a}e=u(e.I);for(f=e.next();!f.done;f=e.next())if(f=f.value,f.Aa(g)){e=f.weight;break a}e=1}g.sampleWeight=e;e=g;g=u(ti);for(f=g.next();!f.done;f=g.next())if(f=f.value,f.da[e.name])for(q=u(f.da[e.name]),h=q.next();!h.done;h=q.next())if(l=h.value,h=e.message.match(l.regexp)){e.params["params.error.original"]=h[0];q=l.groups;l={};for(n=0;n<q.length;n++)l[q[n]]=h[n+1],e.params["params.error."+q[n]]=h[n+1];e.message=f.ia(l);break}e.params||(e.params={});
...
k,value:String(l[k])});l=O("SERVER_NAME",void 0);n=O("SERVER_VERSION",void 0);l&&n&&(q.kvPairs.push({key:"server.name",value:l}),q.kvPairs.push({key:"server.version",value:n}));f={errorMetadata:q,stackTrace:h,logMessage:f}}f&&(si("clientError",f),("ERROR"===g||Q("errors_flush_gel_always_killswitch"))&&eg())}if(!Q("suppress_error_204_logging")){f=e;g=f.params||{};d={urlParams:{a:"logerror",t:"jserror",type:f.name,msg:f.message.substr(0,250),line:f.lineNumber,level:d,"client.name":g.name},postParams:{url:O("PAGE_NAME",
...
f)}xf(O("ECATCHER_REPORT_HOST","")+"/error_204",d)}Fi.add(e.message);Gi++}}}}}else throw v;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function dj(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
...
na(fj,Xi);m=fj.prototype;m.ma=function(){var a=Z(this.i,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!==window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=Z(this.i,"embedConfig")){if(C(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
m.ka=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(C(a))for(var c in a)a.hasOwnProperty(c)&&(this.F[c]=a[c]);break;case "infoDelivery":gj(this,a);break;case "initialDelivery":C(a)&&(window.clearInterval(this.j),this.playerInfo={},this.F={},hj(this,a.apiInterface),gj(this,a));break;default:Yi(this,b,a)}};
